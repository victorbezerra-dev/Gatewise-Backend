...
namespace GateWise.Infrastructure.Migrations
{
    ...
    [Migration("20250713044709_AddLabIdToAccessLogs")]
    partial class AddLabIdToAccessLogs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AccessLog", b =>
                {
                    ...
                    b.HasIndex("LabId")
                        .HasDatabaseName("ix_access_logs_lab_id");
            ...
            modelBuilder.Entity("AccessLog", b =>
                {
                    b.HasOne("GateWise.Core.Entities.Lab", "Lab")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_access_logs_labs_lab_id");
